...
import { createCashOrder, filterOrders, getOrder, getAllOrders, deliverOrder, payOrder } from "../controllers/orders";
import { createOrderValidator, getOrderValidator } from "../utils/validators/ordersValidator";
...
// ordersRoute.route('/:userId/orders').get(allowedTo('user', 'manager', 'admin'), getUserOrders); // Add authorization as needed
